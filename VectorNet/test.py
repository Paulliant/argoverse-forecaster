...
def evaluate(dataset, predictions, labels):
    ...
    for key in predictions:
        ...
        # if key == -1:
        #     max_coordinate = [4890.21696825, 2722.98842652]
        #     min_coordinate = [ 650.30176714, -203.72591182]
        # else:
        #     max_coordinate = [ 971.37104584, 4210.89633146]
        #     min_coordinate = [-494.68405609, 552.63750775]
